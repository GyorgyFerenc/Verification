...
// DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(trepo.XMLfilename);
...
// element.appendChild(createElement(XMLstudent, "Nota",
// String.valueOf(nota.getNota())));
// element.appendChild(createElement(XMLstudent, "SaptamanaPredare",
// String.valueOf(nota.getSaptamanaPredare())));
// element.appendChild(createElement(XMLstudent, "Deadline",
// String.valueOf(t.getDeadline())));
// element.appendChild(createElement(XMLstudent, "Feedback",
// nota.getFeedback()));
//
...
// XMLtransformer.transform(new DOMSource(XMLdocument), new
// StreamResult(XMLfilename));
// }
